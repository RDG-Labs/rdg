...
const ZED_DOCS_URL: &str = "https://github.com/RDG-Labs/rdg/tree/main/docs/src";
...
fn compile_time_release_channel_name() -> String {
    include_str!("../../rdg/RELEASE_CHANNEL").trim().to_string()
}
...
impl ReleaseChannel {
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.rdg.Rdg-Dev",
            ReleaseChannel::Nightly => "dev.rdg.Rdg-Nightly",
            ReleaseChannel::Preview => "dev.rdg.Rdg-Preview",
            ReleaseChannel::Stable => "dev.rdg.Rdg",
        }
    }
...
mod tests {
    ...
    fn test_docs_url_for_release_channel() {
        assert_eq!(
            ...
            "https://github.com/RDG-Labs/rdg/tree/main/docs/src/nightly/settings"
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            "https://github.com/RDG-Labs/rdg/tree/main/docs/src/preview/settings"
        );
        assert_eq!(
            ReleaseChannel::Stable.docs_url("settings"),
            "https://github.com/RDG-Labs/rdg/tree/main/docs/src/settings"
        );
    }
}
