...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["rdg_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["rdg_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["rdg_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        ...
        #[action(deprecated_aliases = ["rdg_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["rdg_actions::OpenKeymapEditor"])]
        OpenKeymap,
