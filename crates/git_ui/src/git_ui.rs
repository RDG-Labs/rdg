...
pub fn init(cx: &mut App) {
    ...
    cx.observe_new(|workspace: &mut Workspace, _, cx| {
        ...
        workspace.register_action(
            |workspace, action: &rdg_actions::CreateWorktree, window, cx| {
        ...
        workspace.register_action(
            |workspace, action: &rdg_actions::SwitchWorktree, window, cx| {
        ...
        workspace.register_action(|workspace, _: &rdg_actions::git::Worktree, window, cx| {
        ...
        workspace.register_action(
            |workspace, action: &rdg_actions::OpenWorktreeInNewWindow, window, cx| {
        ...
        workspace.register_action(
            |workspace, _: &rdg_actions::git::CreatePullRequest, window, cx| {
