...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Rdg Dev Instance Running",
        ReleaseChannel::Nightly => "Rdg Nightly Instance Running",
        ReleaseChannel::Preview => "Rdg Preview Instance Running",
        ReleaseChannel::Stable => "Rdg Stable Instance Running",
    }
}
