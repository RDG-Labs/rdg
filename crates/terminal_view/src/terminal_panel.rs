...
use rdg_actions::assistant::InlineAssist;
...
impl TerminalPanel {
                            ...
                            .menu(move |window, cx| {
                                ...
                                let menu = ContextMenu::build(window, cx, |menu, _, _| {
                                    menu.context(focus_handle.clone())
                                        ...
                                        .action(
                                            "Spawn Task",
                                            rdg_actions::Spawn::modal().boxed_clone(),
                                        )
                                });
    ...
    pub fn add_center_terminal(
        ...
        Self::add_center_terminal_in_direction(workspace, None, window, cx, create_terminal)
    }

    pub(crate) fn add_center_terminal_in_direction(
        workspace: &mut Workspace,
        ...
        cx.spawn_in(window, async move |workspace, cx| {
            ...
            workspace.update_in(cx, |workspace, window, cx| {
                ...
                if let Some(direction) = split_direction {
                    workspace.split_item(direction, Box::new(terminal_view), window, cx);
                } else {
        ...
        let popover_menu = PopoverMenu::new("settings-popover")
            ...
            .menu(move |window, cx| {
                Some(ContextMenu::build(window, cx, |context_menu, _, _| {
                    context_menu
                        .action("Open Settings", rdg_actions::OpenSettings.boxed_clone())
                        .action(
                            "Edit settings.json",
                    ...
                    .child(SplitButton::new(
                        ButtonLike::new("open-settings-ui")
                            ...
                            .on_click(|_, window, cx| {
                                window.dispatch_action(rdg_actions::OpenSettings.boxed_clone(), cx);
                            }),
