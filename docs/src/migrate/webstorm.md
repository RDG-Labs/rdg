...
| Open Terminal Group               | {#kb:jetbrains terminal_group::New}                                                                |
...
- Lean on your terminal ({#kb:jetbrains terminal_group::New}) for anything tasks don't cover
...
| Terminal             | Terminal Group | {#kb:jetbrains terminal_group::New}     |
